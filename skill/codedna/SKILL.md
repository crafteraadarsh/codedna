...
If `codedna` is unavailable in `PATH`, tell the user briefly and continue with normal repository inspection unless they explicitly want the tool installed or repaired.
